    ...
    $.ajax({
        ...
        success: function (data) {
            for (var company in data) {
               // if(data.hasOwnProperty(company)) continue;
                //var k = name;
               // var h = data[company];
                //var r = company;
                CreateCompany(data[company].id, data[company].name, data[company].companyPrice, data[company].parentId);
            }
        }
    });
}
...
var DeleteAll = function DeleteAll() {
    $.ajax({
        ...
        success: function (data) {
            ...
            //var j = parseInt(data.id, 10);
            for ( var i = 0; i <= parseInt(data.id,10); ++i) {
...
var EditCompany = function(id, companyName, price) {
    ...
    name[0].innerHTML = companyName;

    var priceComp= document.getElementsByName(id);
    priceComp[1].innerHTML = price;
}
