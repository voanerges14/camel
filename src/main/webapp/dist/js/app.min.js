window.onload = function LoadFromDb() {
    $.ajax({
        type: 'POST',
        url: '/com.companies/get/companies',
        contentType: 'application/json',
<<<<<<< HEAD
        success: function (data) {
            var obj = JSON.parse(data);
            for (var i = 0; i < obj.length; ++i) {
                CreateCompany(obj[i].id, obj[i].name, obj[i].companyPrice, obj[i].parentId);
            }
        }
    });
}
...
var DeleteCompany = function(id) {
    $.ajax({
        type: 'POST',
        url: '/com.companies/delete/company',
...
var DeleteAll = function() {
    $.ajax({
        type: 'POST',
        url: '/com.companies/delete/companies',
=======
        success: function(data) {
...
>>>>>>> 6e44e51bae1053bcc984f118ed0e09d47f12ff93
        contentType: 'application/json',
        success: function() {
...
var AddCompany = function(id, addOrEdit) {
=======
};
...
<<<<<<< HEAD
        url: addOrEditBool ? '/com.companies/add/company' : '/com.companies/edit/company',
...
var CreateCompany = function(id, name, price, parentId) {
