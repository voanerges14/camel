    ...
    $.ajax({
        ...
        success: function success(data) {
            for (var i = 0; i < data.length; ++i) {
                CreateCompany(data.id, data.name, data.prize, data.parentId);
            }
        }
    });
}
...
var AddCompany = function AddCompany(id, addOrEdit) {
    ...
    if (companyName == null || prize == null) return;
    ...
    $.ajax({
        ...
        contentType: 'application/json',
        url: url,
        data: JSON.stringify({ id: id, name: name, prize: prize }),
        success: function success(newId) {
            CreateCompany(newId, name, prize, id);
        }
    });
};
...
var CreateCompany = function CreateCompany(id, name, prize, parentId) {
